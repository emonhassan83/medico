...
const DoctorDetail = ({ params }: any) => {
  ...
  return (
    <>
    <Meta
        title="Details Doctor| Medico - Hospital & Clinic Management System"
        description="This is the details of Doctor list page of Medico where doctor can view details of Doctor and more."
      />
